...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#FDF8F9] font-sans text-[#333333]">
      {/* Header */}
      <header className="bg-white px-8 py-4 flex items-center justify-between border-b border-gray-100">
        <div className="text-2xl font-bold tracking-tight text-[#B0003A] uppercase">Maison</div>
        <nav className="hidden md:flex items-center space-x-8 text-sm font-medium text-gray-600">
          <a href="#" className="hover:text-[#B0003A] transition-colors">Shop</a>
          <a href="#" className="hover:text-[#B0003A] transition-colors">About</a>
        </nav>
        <div className="flex items-center space-x-5">
          <button className="text-gray-600 hover:text-[#B0003A] transition-colors">
      ...
      <main className="flex-1 flex items-center justify-center p-6 md:p-12">
        <div className="w-full max-w-6xl bg-white rounded-3xl shadow-[0_20px_50px_rgba(176,0,58,0.05)] overflow-hidden flex flex-col md:flex-row min-h-[650px]">
          ...
          <div className="w-full md:w-1/2 relative bg-[#B0003A] flex flex-col justify-center p-12 md:p-16 text-white overflow-hidden">
            <div className="absolute inset-0 z-0">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-tr from-[#B0003A]/90 via-[#B0003A]/40 to-transparent"></div>
            </div>
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-12 pr-4 py-3.5 rounded-xl border border-gray-200 bg-white focus:ring-4 focus:ring-[#B0003A]/5 focus:border-[#B0003A] outline-none transition-all text-sm"
                    />
                  </div>
                </div>
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    ...
                    {mode === 'Login' && (
                      <a href="#" className="text-[11px] text-[#B0003A] font-bold hover:underline uppercase">
                        Forgot password?
                      </a>
                    )}
                  </div>
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-12 pr-12 py-3.5 rounded-xl border ${passwordError ? 'border-red-500' : 'border-gray-200'} bg-white focus:ring-4 focus:ring-[#B0003A]/5 focus:border-[#B0003A] outline-none transition-all text-sm`}
                    />
                    <button
                      type="button"
                ...
                {mode === 'Login' && (
                  <div className="flex items-center">
                    <input
                      type="checkbox"
                      id="remember"
                      className="h-4 w-4 text-[#B0003A] focus:ring-[#B0003A] border-gray-300 rounded cursor-pointer"
                    />
                ...
                <button
                  ...
                  className={`w-full bg-[#B0003A] hover:bg-[#900030] text-white font-bold py-4 px-4 rounded-2xl shadow-lg shadow-[#B0003A]/20 transition-all flex items-center justify-center space-x-2 ${password.length < 8 ? 'opacity-50 cursor-not-allowed' : ''}`}
                >
      ...
      <footer className="bg-white border-t border-gray-100 px-8 py-8">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
          ...
          <div className="flex items-center space-x-6">
            <a href="#" className="text-[10px] font-bold text-gray-600 hover:text-[#B0003A] transition-colors uppercase tracking-tight">Terms of Service</a>
            <a href="#" className="text-[10px] font-bold text-gray-600 hover:text-[#B0003A] transition-colors uppercase tracking-tight">Privacy Policy</a>
            <a href="#" className="text-[10px] font-bold text-gray-600 hover:text-[#B0003A] transition-colors uppercase tracking-tight">Cookie Settings</a>
            <a href="#" className="text-[10px] font-bold text-gray-600 hover:text-[#B0003A] transition-colors uppercase tracking-tight">Support</a>
          </div>
        </div>
      </footer>
    </div>
